...
Adapted from uv's agents/hooks/post-edit-format.py (https://github.com/astral-sh/uv),
MIT OR Apache-2.0, trimmed to the languages treehawk actually contains.
"""
