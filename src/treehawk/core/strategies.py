...
from treehawk.core.interfaces import ExpansionContext, ExpansionStrategy
...
class GroupExpansion:
    ...
    * treehawk itself must not live in it (or under it), and
    * every process currently in it must already be tracked.
    ...
    later are adopted immediately. A boundary created by treehawk itself
